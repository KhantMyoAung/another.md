...
export const SCIENTISTS = [
  /* ────────────────────────────────────────────────────────────── 01 ── */
  {
    ...
    accent2: '#ffd400',
        game: 'vortex',
    gameTitle: 'The Aortic Vortex',
    gameBrief: 'Pump the grass seeds through the glass root and find the flow where the eddies form.',
    gameHint: 'Too slow and nothing turns. Too fast and it blows straight past the cusps.',
    ink: 'red',
rarity: 'legendary',
  ...
  /* ────────────────────────────────────────────────────────────── 02 ── */
  {
    ...
    accent2: '#ffd400',
        game: 'oring',
    gameTitle: 'The O-Ring',
    gameBrief: 'Clamp it, chill it, let go. Find the temperature at which the rubber stops springing back.',
    gameHint: 'He did exactly this on live television, with a C-clamp and a glass of ice water.',
    ink: 'blue',
rarity: 'legendary',
  ...
  /* ────────────────────────────────────────────────────────────── 03 ── */
  {
    ...
    accent2: '#e6242a',
        game: 'camera',
    gameTitle: 'The Dark Room',
    gameBrief: 'Three lamps, one aperture. Put one out and watch what happens on the far wall.',
    gameHint: 'If light mixed in the air on the way through, the patches could not stay separate.',
    ink: 'yellow',
rarity: 'underrated',
  ...
  /* ────────────────────────────────────────────────────────────── 04 ── */
  {
    ...
    accent2: '#0b63d6',
        game: 'symmetry',
    gameTitle: 'The Symmetry Bench',
    gameBrief: 'Apply a continuous symmetry. Exactly one quantity will refuse to drift.',
    gameHint: 'Four symmetries, four conservation laws. Find all four.',
    ink: 'red',
rarity: 'underrated',
  ...
  /* ────────────────────────────────────────────────────────────── 05 ── */
  {
    ...
    accent2: '#ffd400',
        game: 'parity',
    gameTitle: 'The Cobalt Mirror',
    gameBrief: 'Cool the crystal, align the nuclear spins, then count the electrons.',
    gameHint: 'Thermal jostling randomises the spins. You need thousandths of a kelvin.',
    ink: 'blue',
rarity: 'underrated',
